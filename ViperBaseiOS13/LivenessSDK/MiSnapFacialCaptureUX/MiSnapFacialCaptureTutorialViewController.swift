...
class MiSnapFacialCaptureTutorialViewController: UIViewController {
    ...
    private var delegate: MiSnapFacialCaptureTutorialViewControllerDelegate?
...
extension MiSnapFacialCaptureTutorialViewController {
    ...
    private func configureForGeneric() {
        ...
        continueButton.backgroundColor = UIColor(red: 252/255.0, green: 0/255.0, blue: 42/255.0, alpha: 1.0)
        ...
        retryButton.backgroundColor = UIColor(red: 252/255.0, green: 0/255.0, blue: 42/255.0, alpha: 1.0)
    ...
    private func configureForTimeout() {
        ...
        let timeUpLabel = label(withFrame: CGRect(x: 0, y: 0, width: view.frame.size.width, height: 40), localizeKey: "misnap_facial_capture_ux_tutorial_timeout_message_1", fontSize: 19.0, fontWeigth: .regular)
        view.addSubview(timeUpLabel)
        
        let retryLabel = label(withFrame: CGRect(x: 0, y: 0, width: view.frame.size.width, height: 40), localizeKey: "misnap_facial_capture_ux_tutorial_timeout_message_2", fontSize: 19.0, fontWeigth: .regular)
    ...
    private func configureForReview(with image: UIImage?) {
        ...
        let messageLabel = label(withFrame: CGRect(x: 0, y: 0, width: view.frame.width, height: view.frame.height * 0.07), localizeKey: "misnap_facial_capture_ux_tutorial_review_message", fontSize: 19.0, fontWeigth: .regular)
    ...
    private func viewWithInstructionImage(named name: String, localizeKey: String) -> UIView {
        ...
        var manualImageView: UIImageView? = nil
        if isManual {
    ...
    private func bestFontSizeForInstruction(in bounds: CGRect) -> UIFont {
        ...
        for string in instructionStrings {
            if string.count > maxLengthString.count {
