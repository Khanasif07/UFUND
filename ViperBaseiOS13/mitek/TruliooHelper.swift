...
//    private let basePath = "https://api.globalgateway.io/"
    ...
    private func getVerifyRequest(piiInfo: PiiInfo) -> DocumentVerificationRequest{
        ...
        let dataFields = DataFields(personInfo: PersonInfo(piiInfo: piiInfo), documentInfo: Document(frontImage: frontImageString!, backImage: backImageString, livePhoto: liveImageString, documentType: piiInfo.documentType),locationInfo: Location(piiInfo: piiInfo, additionalFields: AdditionalFields(piiInfo: piiInfo)), nationalIdInfo: [NationalIds(piiInfo: piiInfo)])
