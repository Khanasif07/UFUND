...
let stripeKey = ""
let appClientId = 2
let baseUrl = "https://ufund.online"//"http://54.236.180.74"//http://ufunddevonline.appskeeper.in" //http://54.236.180.74"  //"http://ufunddevadmin.appskeeper.in" //"http://54.88.124.37"
let deviceIds = "1"
