...
extension AssetsFilterDateVC {
    ...
    private func initialSetup() {
        ...
        fromTextField.setButtonToRightView(btn: buttonView, selectedImage: #imageLiteral(resourceName: "icCalendar"), normalImage: #imageLiteral(resourceName: "icCalendar"), size: CGSize(width: 20, height: 20),isUserInteractionEnabled: false)
        toTextField.setButtonToRightView(btn:   buttonView1, selectedImage: #imageLiteral(resourceName: "icCalendar"), normalImage: #imageLiteral(resourceName: "icCalendar"), size: CGSize(width: 20, height: 20),isUserInteractionEnabled: false)
